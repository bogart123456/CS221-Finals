    ...
    <footer className="bg-[#000000] text-white py-12 md:py-16">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="flex flex-col justify-between h-full space-y-6 md:space-y-0">
            <div>
              <p className="text-gray-200 text-sm leading-relaxed max-w-xs">
                Only the best authentic LEVI'S® products crafted with quality
                and style. Experience timeless fashion with us.
              </p>
            </div>
          ...
          <div>
            <h3 className="text-base font-bold mb-6 text-white uppercase tracking-wider">
              Quick Links
            </h3>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-gray-300 font-medium mb-6">
              ...
              <p>
                Email:{" "}
                <a
                  href="mailto:info@fabricateandstyle.com"
                  className="hover:text-white"
                >
                  info@levisackermans.ph
                </a>
              </p>
              <p>
                Phone:{" "}
                <a href="tel:+63281234567" className="hover:text-white">
                  +63 (2) 8123 4567
                </a>
              </p>
            </div>
