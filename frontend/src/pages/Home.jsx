...
const Home = () => {
  ...
  const getImageUrl = (imagePath) => {
    if (!imagePath)
      return "https://placehold.co/600x400/e0e0e0/555555?text=No+Image";
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-white">
            The Best Selection of Levi's® Clothing for Everyone.
          </h1>
          <p className="text-lg md:text-xl text-gray-200 mb-10 max-w-2xl mx-auto">
            An official Levi's® retailer offering a wide range of authentic
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {categories.map((cat, index) => (
                <div
                  key={index}
                  className="group bg-white border rounded-xl overflow-hidden shadow hover:shadow-2xl transition"
                >
