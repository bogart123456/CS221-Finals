...
const Checkout = () => {
  ...
  // Safety Check: If user refreshes page, state is lost. Redirect to products.
  useEffect(() => {
      ...
      <div className="min-h-screen flex items-center justify-center p-4 bg-gray-50">
        <div className="bg-white p-8 rounded-2xl shadow-xl text-center max-w-md w-full animate-fade-in-up">
          ...
          <p className="text-gray-600 mb-6">
            ...
            <strong>{product.name}</strong> has been placed successfully.
          </p>
              ...
              <div className="space-y-4">
                ...
                >
                  <div className="w-12 h-12 bg-blue-50 rounded-lg flex items-center justify-center mr-4">
                    ...
                    />
                    <Smartphone
                      className="w-6 h-6 text-blue-500 hidden"
                      style={{ display: "none" }}
                    />
                  </div>
                  <div className="flex-1">
                    ...
                    <span className="text-sm text-gray-500">
                      Pay securely using your GCash wallet
                    </span>
                  </div>
                  <div
