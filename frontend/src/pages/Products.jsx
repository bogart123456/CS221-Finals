...
const ProductCard = ({ product }) => {
  ...
  return (
    ...
    >
      ...
      <div className="h-48 flex items-center justify-center relative bg-gray-50 overflow-hidden">
        ...
        imageSrc !==
          ...
          <Image
            ...
            style={{ color: "var(--color-secondary-subtle)" }}
          />
        )}
      </div>
      ...
      <div className="p-5">
        <h3
          className="text-lg font-bold mb-2 truncate transition-colors duration-300 group-hover:text-blue-600"
        ...
        <div className="flex justify-between items-center pt-4 border-t border-gray-100">
          <span
            ...
            style={{ color: "var(--color-secondary-highlight)" }}
          >
            $
            {product.price
          ...
          <button
            ...
            className="flex items-center text-[#fff] px-5 py-2.5 rounded-full text-sm font-bold shadow-md 
...
const ProductPage = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        ...
        const url = `${API_BASE_URL}/products/getProducts${
        ...
        setError(
          "Failed to load products. Please check the backend server and network connection."
        );
      } finally {
        setLoading(false);
      }
  ...
  const inputTransitionClass =
    "w-full p-3 border rounded-xl shadow-sm transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-[var(--color-primary-accent)] focus:border-transparent hover:shadow-md";
        ...
        <div className="mb-6" ref={dropdownRef}>
          ...
          <div className="relative">
            ...
            <button
              ...
              className={`w-full p-3 bg-white border rounded-xl shadow-sm flex justify-between items-center text-left transition-all duration-300 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-[var(--color-primary-accent)] ${
                isDropdownOpen
                  ? "ring-2 ring-[var(--color-primary-accent)] border-transparent"
                  : ""
              }`}
              style={{ borderColor: "var(--color-primary-dark)" }}
            >
            ...
            >
              <div className="overflow-y-auto max-h-60">
                <button
                  ...
                  className={`w-full px-4 py-3 text-left text-sm hover:bg-blue-50 transition-colors duration-150 flex items-center justify-between ${
                    selectedCategory === ""
                ...
                {categories.map((category) => (
                  <button
                    ...
                    className={`w-full px-4 py-3 text-left text-sm hover:bg-blue-50 transition-colors duration-150 flex items-center justify-between border-t border-gray-50 ${
