...
const Contact = () => {
  ...
  const inputClasses =
    "w-full p-4 border border-gray-300 bg-white text-gray-800 focus:outline-none focus:ring-2 focus:ring-[var(--color-primary-accent)] focus:border-transparent transition-all duration-200";
  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
        ...
        <div>
          <h3
            className="text-xl font-normal tracking-widest text-center mb-8 uppercase"
            style={{ color: "var(--color-primary-dark)" }}
          >
            Online Inquiry
          </h3>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start space-x-3 pt-2">
              ...
              >
                ...
                communications. This consent isn't necessary for purchasing any
                products or services and you may opt out at any time.
              </label>
            </div>
        ...
        <div className="text-center flex flex-col items-center">
          <h3
            className="text-xl font-normal tracking-widest text-center w-full mb-8 uppercase"
            style={{ color: "var(--color-primary-dark)" }}
          >
            Contact Details
          </h3>
          ...
          <div className="space-y-10 text-gray-600 w-full">
            ...
            <div className="flex flex-col items-center">
              <a
                href="mailto:info@leviackermans.ph"
                className="text-lg font-medium underline decoration-1 underline-offset-4 mb-1 hover:text-blue-600 transition"
              >
                info@leviackermans.ph
              </a>
