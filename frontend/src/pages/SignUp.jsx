...
const SignUp = () => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      ...
      try {
        ...
        if (response.ok) {
          ...
          setSubmitMessage(
            `🎉 Signup successful! You will be redirected to login.`
          );
  ...
  const inputClass = (fieldName, hasIcon = true) =>
    `w-full p-3 rounded-xl outline-none transition-all duration-200 focus:ring-4 focus:ring-offset-2 shadow-sm ${
      hasIcon ? "pl-10" : ""
    } ${
      errors[fieldName]
  ...
  const iconBaseClass =
    "absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400 pointer-events-none";
  ...
  return (
    ...
    >
      <div className="w-full max-w-lg bg-white p-8 md:p-10 shadow-2xl rounded-2xl border border-gray-100">
        <h2
          className="text-3xl font-extrabold mb-8 text-center flex items-center justify-center"
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex flex-col md:flex-row md:space-x-4 space-y-5 md:space-y-0">
            <div className="w-full">
              ...
              <input
                ...
                className={inputClass("firstName", false)}
              />
              {errors.firstName && (
          ...
          {submitMessage && (
            <p
              className={`mt-4 p-3 rounded-xl text-center font-semibold flex items-center justify-center ${
                submitMessage.includes("successful")
                  ? "bg-[var(--color-light-accent)] text-[var(--color-primary-dark)]"
          ...
          <div className="text-center mt-6 pt-4 border-t border-gray-200">
            <p className="text-sm text-gray-600">
              ...
              <a
                href="/login"
                className="font-bold text-blue-500 hover:opacity-80 transition duration-150"
              >
                Log In
              </a>
            </p>
